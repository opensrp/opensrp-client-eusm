...
import org.smartregister.eusm.adapter.AvailableOfflineMapAdapter;
...
import org.smartregister.eusm.presenter.AvailableOfflineMapsPresenter;
import org.smartregister.eusm.task.FileHttpServerTask;
...
public class AvailableOfflineMapsFragment extends BaseOfflineMapsFragment implements AvailableOfflineMapsContract.View, View.OnClickListener {
    ...
    private static final Gson gson = new GsonBuilder().setDateFormat(AppConstants.DateFormat.EVENT_DATE_FORMAT_Z)
