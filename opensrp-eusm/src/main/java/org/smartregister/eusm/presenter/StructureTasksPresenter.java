...
import org.smartregister.eusm.interactor.StructureTasksInteractor;
...
import static org.smartregister.eusm.contract.StructureTasksContract.Interactor;
import static org.smartregister.eusm.contract.StructureTasksContract.Presenter;
...
public class StructureTasksPresenter extends BaseFormFragmentPresenter implements Presenter {
    ...
    private final WeakReference<StructureTasksContract.View> view;
...
//                getView().showProgressDialog(R.string.opening_form_title, R.string.opening_form_message);
    ...
    public void onLocationValidated() {
        ...
        if (taskDetails.isEdit() && (AppConstants.Intervention.BEDNET_DISTRIBUTION.equals(taskDetails.getTaskCode()) || AppConstants.Intervention.BLOOD_SCREENING.equals(taskDetails.getTaskCode()))) {
...
//            getView().displayError(R.string.opening_form_title, R.string.form_not_found);
            ...
            if (AppConstants.Intervention.BEDNET_DISTRIBUTION.equals(getTaskDetails().getTaskCode())) {
