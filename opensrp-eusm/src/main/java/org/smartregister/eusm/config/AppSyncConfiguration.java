...
public class AppSyncConfiguration extends SyncConfiguration {
    ...
    public AppSyncConfiguration() {
    }

    public AppSyncConfiguration(LocationRepository locationRepository, AllSharedPreferences sharedPreferences) {
    ...
    public String getSettingsSyncFilterValue() {
        if (sharedPreferences == null) {
            sharedPreferences = EusmApplication.getInstance().getContext().userService().getAllSharedPreferences();
        }
