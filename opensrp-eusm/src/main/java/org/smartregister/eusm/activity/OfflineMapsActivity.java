...
import org.smartregister.eusm.fragment.AvailableOfflineMapsFragment;
import org.smartregister.eusm.fragment.DownloadedOfflineMapsFragment;
...
public class OfflineMapsActivity extends MultiLanguageActivity implements OfflineMapDownloadCallback {
    ...
    protected ViewPager setupViewPager() {
        ...
        availableOfflineMapsFragment = AvailableOfflineMapsFragment.newInstance(getIntent().getExtras());
        availableOfflineMapsFragment.setOfflineMapDownloadCallback(this);
        adapter.addFragment(availableOfflineMapsFragment, getString(R.string.available).toUpperCase());
        ...
        adapter.addFragment(downloadedOfflineMapsFragment, getString(R.string.downloaded).toUpperCase());
