...
public class RepeatingGroupGenerator {
    ...
    private final String repeatingGroupKey;
    private final String uniqueKeyField;
    private final List<HashMap<String, String>> storedValues;
...
//        }
        ...
        if (repeatingGrpFieldKey.equals(AppConstants.JsonForm.GENERATED_GRP))
