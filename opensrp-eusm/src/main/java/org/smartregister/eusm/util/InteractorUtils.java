...
import static org.smartregister.eusm.util.AppConstants.DatabaseKeys.BASE_ENTITY_ID;
import static org.smartregister.eusm.util.AppConstants.DatabaseKeys.CASE_CONFIRMATION_FIELD;
import static org.smartregister.eusm.util.AppConstants.DatabaseKeys.EVENT_TASK_TABLE;
import static org.smartregister.eusm.util.AppConstants.DatabaseKeys.EVENT_TYPE_FIELD;
import static org.smartregister.eusm.util.AppConstants.DatabaseKeys.FORM_SUBMISSION_ID;
import static org.smartregister.eusm.util.AppConstants.DatabaseKeys.SPRAYED_STRUCTURES;
import static org.smartregister.eusm.util.AppConstants.DatabaseKeys.TASK_ID;
import static org.smartregister.eusm.util.AppConstants.Intervention.BCC;
import static org.smartregister.eusm.util.AppConstants.Intervention.CASE_CONFIRMATION;
import static org.smartregister.eusm.util.AppConstants.Intervention.IRS;
...
public class InteractorUtils {
    ...
    public InteractorUtils(TaskRepository taskRepository, EventClientRepository eventClientRepository, AppClientProcessor clientProcessor) {
        ...
        if (IRS.equals(interventionType)) {
            ...
            try {
                cursor = eventClientRepository.getWritableDatabase().rawQuery(
                        String.format("select s.*, id as _id from %s s where %s = ?", SPRAYED_STRUCTURES, AppConstants.DatabaseKeys.BASE_ENTITY_ID), new String[]{structureId});
    ...
    public boolean archiveClient(String baseEntityId, boolean isFamily) {
        ...
        try {
            ...
            EusmApplication.getInstance().setSynced(false);
