...
import static org.smartregister.eusm.util.AppConstants.SPRAY_EVENT;
...
public class AppClientProcessorPowerMockTest {
    ...
    private final StructureRepository structureRepository = mock(StructureRepository.class);
    private final String TRAP_SET_DATE = "11/11/1977";
    private final String TRAP_FOLLOW_UP_DATE = "02/09/1983";
    ...
    @Before
    public void setUp() {
        clientProcessor = spy(Whitebox.newInstance(AppClientProcessor.class));
    }
    ...
    public void testProcessClientShouldCallProcessPOATEventWhenIsPOATEventType() throws Exception {
        ...
        List<EventClient> eventClients = new ArrayList<>();
        event.setEventType(AppConstants.EventType.PAOT_EVENT);
    ...
    private void mockStaticMethods() {
        ...
        EusmApplication application = mock(EusmApplication.class);
        when(EusmApplication.getInstance()).thenReturn(application);
