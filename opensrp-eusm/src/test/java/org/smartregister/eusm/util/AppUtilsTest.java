...
import static org.smartregister.eusm.util.AppConstants.CONFIGURATION.ADMIN_PASSWORD_NOT_NEAR_STRUCTURES;
import static org.smartregister.eusm.util.AppConstants.CONFIGURATION.DEFAULT_GEO_JSON_CIRCLE_SIDES;
import static org.smartregister.eusm.util.AppConstants.CONFIGURATION.DEFAULT_INDEX_CASE_CIRCLE_RADIUS_IN_METRES;
import static org.smartregister.eusm.util.AppConstants.CONFIGURATION.DISPLAY_ADD_STRUCTURE_OUT_OF_BOUNDARY_WARNING_DIALOG;
import static org.smartregister.eusm.util.AppConstants.CONFIGURATION.DISPLAY_DISTANCE_SCALE;
import static org.smartregister.eusm.util.AppConstants.CONFIGURATION.RESOLVE_LOCATION_TIMEOUT_IN_SECONDS;
import static org.smartregister.eusm.util.AppConstants.CONFIGURATION.VALIDATE_FAR_STRUCTURES;
...
import static org.smartregister.eusm.util.AppConstants.Intervention.LARVAL_DIPPING;
import static org.smartregister.eusm.util.AppConstants.Intervention.MOSQUITO_COLLECTION;
import static org.smartregister.eusm.util.AppConstants.Intervention.REGISTER_FAMILY;
import static org.smartregister.eusm.util.AppUtils.createCircleFeature;
import static org.smartregister.eusm.util.AppUtils.displayAddStructureOutOfBoundaryWarningDialog;
import static org.smartregister.eusm.util.AppUtils.displayDistanceScale;
import static org.smartregister.eusm.util.AppUtils.getAdminPasswordNotNearStructures;
import static org.smartregister.eusm.util.AppUtils.getCoordinatesFromGeometry;
import static org.smartregister.eusm.util.AppUtils.getDrawOperationalAreaBoundaryAndLabel;
import static org.smartregister.eusm.util.AppUtils.getResolveLocationTimeoutInSeconds;
import static org.smartregister.eusm.util.AppUtils.isResidentialStructure;
import static org.smartregister.eusm.util.AppUtils.validateFarStructures;

/**
 * Created by Vincent Karuri on 08/05/2019
 */
@RunWith(PowerMockRunner.class)
@PrepareForTest({PreferencesUtil.class, MapboxMap.class, EusmApplication.class})
public class AppUtilsTest {
    ...
    public void testgetDrawOperationalAreaBoundaryAndLabelReturnsDefaultValueWhenSettingsValueIsNull() throws Exception {
        EusmApplication eusmApplication = initRevealApplicationMock();

        when(eusmApplication.getServerConfigs()).thenReturn(new HashMap<>());
        assertEquals(getDrawOperationalAreaBoundaryAndLabel(), AppConstants.CONFIGURATION.DEFAULT_DRAW_OPERATIONAL_AREA_BOUNDARY_AND_LABEL);
    }
    ...
    public void testgetDrawOperationalAreaBoundaryAndLabelReturnsFalseWhenSettingsValueIsFalse() throws Exception {
        ...
        when(eusmApplication.getServerConfigs()).thenReturn(settings);
    ...
    private EusmApplication initRevealApplicationMock() throws Exception {
        PowerMockito.mockStatic(EusmApplication.class);
        EusmApplication eusmApplication = mock(EusmApplication.class);
        PowerMockito.when(EusmApplication.class, "getInstance").thenReturn(eusmApplication);
        return eusmApplication;
    }
    ...
    public void testGetCoordsFromGeometryReturnsCorrectValuesFromPolygon() {
        ...
        JSONArray actualCoords = getCoordinatesFromGeometry(editedFeature.geometry(), originalFeature.geometry());
